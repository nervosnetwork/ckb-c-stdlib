...
static void blake3_hasher_finalize_seek(const blake3_hasher *self, uint64_t seek,
...
static void blake3_hasher_init(blake3_hasher *self) { hasher_init_base(self, IV, 0); }
